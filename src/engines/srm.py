...
#
# Constituent lists below are the GRADING lists. Duplicates across baskets are
# intentional — each basket grades independently via its own equal-weight index.
# 35 baskets across 9 sector groups.
THEMATIC_BASKETS: dict[str, dict] = {
    # ── Mega-cap leadership ─────────────────────────────────────────────────
    "Mag7":              {"parent_gics_etf": "XLK",
                          "constituents": ["AAPL", "MSFT", "NVDA", "AMZN", "GOOG",
                                           "META", "TSLA"]},
    # ── AI & Technology ─────────────────────────────────────────────────────
    "AI_Infrastructure": {"parent_gics_etf": "XLRE",
                          "constituents": ["EQIX", "DLR", "AMT", "SMCI", "APLD", "ANET",
                                           "NBIS", "IREN", "CORZ", "CCI", "WULF", "SBAC"]},
    "AI_Software":       {"parent_gics_etf": "XLK",
                          "constituents": ["PLTR", "APP", "SOUN", "PATH", "BBAI",
                                           "SAIL", "INOD", "AI", "CRM"]},
    "Semiconductors":    {"parent_gics_etf": "XLK",
                          "constituents": ["NVDA", "AMD", "AVGO", "CRDO", "AMAT", "KLAC",
                                           "LRCX", "MRVL", "MU", "QCOM", "TXN", "ADI",
                                           "NXPI", "MCHP", "ARM"]},
    "Chip_Equipment":    {"parent_gics_etf": "XLK",
                          "constituents": ["AMAT", "KLAC", "LRCX", "ENTG", "COHR",
                                           "AMKR", "FORM", "ACMR", "AEHR", "SNPS",
                                           "CDNS"]},
    "Enterprise_Software": {"parent_gics_etf": "XLK",
                            "constituents": ["NOW", "DDOG", "SNOW", "TEAM", "MNDY", "DOCU",
                                             "DOCN", "BRZE", "DBX", "BOX", "PATH", "FRSH",
                                             "GTLB", "ZM", "ESTC", "U", "NTNX", "DT",
                                             "AVPT", "CRM", "HUBS"]},
    "Cloud_Computing":   {"parent_gics_etf": "XLK",
                          "constituents": ["AMZN", "MSFT", "GOOG", "ORCL", "SNOW", "NET",
                                           "DDOG", "MDB", "ESTC", "NTNX", "DOCN", "DBX",
                                           "AKAM"]},
    "Cybersecurity":     {"parent_gics_etf": "XLK",
                          "constituents": ["FTNT", "CRWD", "PANW", "ZS", "OKTA", "S",
                                           "CYBR", "TENB", "VRNS", "NET", "RBRK", "QLYS",
                                           "RPD"]},
    "Quantum_Computing": {"parent_gics_etf": "XLK",
                          "constituents": ["IONQ", "QBTS", "QUBT", "RGTI", "INFQ"]},
    ...
    "Infra_Construction": {"parent_gics_etf": "XLI",
                           "constituents": ["CAT", "UNP", "CSX", "CARR", "FLEX", "APH",
                                            "KEYS", "HWM", "DNOW", "CNM", "MDU", "GTES",
                                            "LGN"]},
    "Autonomous_Robotics": {"parent_gics_etf": "XLI",
                            "constituents": ["AUR", "CGNX", "OUST", "TER", "IRDM", "MBLY",
                                             "SYM", "KTOS", "AVAV"]},
    "Transport_Logistics": {"parent_gics_etf": "XLI",
                            "constituents": ["UNP", "CSX", "ODFL", "KNX", "CHRW", "JBLU",
                                             "UAL", "DAL", "LUV", "ALK", "RXO", "LYFT"]},
    # ── Energy ──────────────────────────────────────────────────────────────
    "Nuclear_Energy":    {"parent_gics_etf": "XLE",
                          "constituents": ["OKLO", "SMR", "CCJ", "LEU", "NNE", "BWXT"]},
    "Solar_Renewables":  {"parent_gics_etf": "XLU",
                          "constituents": ["FSLR", "ENPH", "SEDG", "RUN", "SHLS", "NXT",
                                           "PLUG", "BE", "FLNC", "EOSE", "WOLF"]},
    "Oil_Services":      {"parent_gics_etf": "XLE",
                          "constituents": ["HAL", "SLB", "PTEN", "NOV", "LBRT", "WTTR",
                                           "NESR", "PUMP"]},
    "Midstream_MLP":     {"parent_gics_etf": "XLE",
                          "constituents": ["ET", "EPD", "MPLX", "WES", "PAA", "PAGP",
                                           "OKE", "WMB", "HESM", "AROC"]},
    # ── Materials & Commodities ─────────────────────────────────────────────
    "Critical_Minerals": {"parent_gics_etf": "XLB",
                          "constituents": ["FCX", "AA", "MP", "CLF", "IE", "CENX", "ATI",
                                           "SCCO", "ALB", "SQM", "TGB"]},
    "Gold_Miners":       {"parent_gics_etf": "XLB",
                          "constituents": ["NEM", "GOLD", "AEM", "FNV", "WPM", "KGC",
                                           "GFI", "AGI", "RGLD"]},
    "Agri_Commodities":  {"parent_gics_etf": "XLB",
                          "constituents": ["ADM", "MOS", "NTR", "CTVA", "DE", "CF",
                                           "FMC", "BG"]},
    # ── Financials ──────────────────────────────────────────────────────────
    "Big_Banks":         {"parent_gics_etf": "XLF",
                          "constituents": ["JPM", "GS", "MS", "BAC", "C", "BNY", "COF",
                                           "KEY", "RF", "WFC"]},
    "Fintech":           {"parent_gics_etf": "XLF",
                          "constituents": ["XYZ", "AFRM", "UPST", "KLAR", "GPN", "GLXY",
                                           "BULL", "KEEL", "SOFI"]},
    "Crypto_Digital":    {"parent_gics_etf": "XLF",
                          "constituents": ["MSTR", "HOOD", "COIN", "MARA", "RIOT", "CLSK",
                                           "BTDR", "HUT", "CIFR", "IREN", "CORZ", "WULF"]},
    "Insurance":         {"parent_gics_etf": "XLF",
                          "constituents": ["MET", "AFL", "PRU", "EQH", "GNW", "ALL",
                                           "TRV", "PGR", "CB", "AIG"]},
    "Payments":          {"parent_gics_etf": "XLK",
                          "constituents": ["V", "MA", "GPN", "AXP", "PYPL", "SQ",
                                           "FIS", "FISV", "FOUR"]},
    # ── Consumer ────────────────────────────────────────────────────────────
    "Gaming_Streaming":  {"parent_gics_etf": "XLC",
                          "constituents": ["DKNG", "TTWO", "RDDT", "RUM", "ROKU", "SPOT",
                                           "DIS", "WMG", "SIRI", "SNAP", "U", "RBLX",
                                           "NFLX"]},
    "E_Commerce":        {"parent_gics_etf": "XLY",
                          "constituents": ["AMZN", "ETSY", "EBAY", "W", "CVNA", "CART",
                                           "SE", "JD", "BIDU"]},
    "Travel_Leisure":    {"parent_gics_etf": "XLY",
                          "constituents": ["CCL", "RCL", "UAL", "DAL", "LUV", "ALK",
                                           "MGM", "CZR", "LYV", "VIK", "BIRK", "DKNG"]},
    "Homebuilders":      {"parent_gics_etf": "XLY",
                          "constituents": ["DHI", "LEN", "TOL", "KBH", "TMHC", "MTH",
                                           "MAS", "TREX"]},
    # ── Healthcare ──────────────────────────────────────────────────────────
    "Biotech":           {"parent_gics_etf": "XLV",
                          "constituents": ["AMGN", "GILD", "REGN", "VRTX", "BIIB",
                                           "MRNA", "BMY", "ABBV", "LLY", "PFE"]},
    "MedTech":           {"parent_gics_etf": "XLV",
                          "constituents": ["ISRG", "SYK", "MDT", "ABT", "BSX", "EW",
                                           "DXCM", "HOLX", "ALGN", "ZBH"]},
    # ── Real Estate ─────────────────────────────────────────────────────────
    "REITs":             {"parent_gics_etf": "XLRE",
                          "constituents": ["EQIX", "DLR", "AMT", "CCI", "PLD", "WELL",
                                           "VICI", "O", "INVH", "AMH", "EQR", "REXR",
                                           "SBAC", "OHI"]},
    # ── Communication ───────────────────────────────────────────────────────
    "Social_Media":      {"parent_gics_etf": "XLC",
                          "constituents": ["META", "SNAP", "PINS", "RDDT", "RUM", "TTD",
                                           "APP", "GOOG"]},
}
    ...
    for name, info in THEMATIC_BASKETS.items():
        ...
        if sub is None or sub.shape[1] < min_constituents or len(sub) < 25:
            out[name] = {
                ...
                "pattern": None, "pattern_direction": None,
                "pattern_stage": None, "pattern_trigger": None,
        ...
        out[name] = {
            ...
            "pattern_direction": pattern.get("pattern_direction"),
